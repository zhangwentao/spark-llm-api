...
class Client extends events_1.EventEmitter {
    constructor(params) {
        super();
        const { apiKey, apiSecret, appId, version = types_1.Constants.DEFAULT_VERSION, protocal = types_1.Constants.DEFAULT_PROTOCAL, host = types_1.Constants.DEFAULT_HOST } = params;
        this.appId = appId;
    ...
    resolveDomain(params) {
        ...
        const mainVersion = (_a = version.match(/v(\d)\.\d*/)) === null || _a === void 0 ? void 0 : _a[1];
        let domain;
        switch (mainVersion) {
            case '1':
                domain = types_1.DomainEnum.GENERAL;
                break;
            case '2':
                domain = types_1.DomainEnum.GENERAL_V2;
                break;
            case '3':
                domain = types_1.DomainEnum.GENERAL_V3;
                break;
        }
        return domain;
    }
