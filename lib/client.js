...
class Client extends events_1.EventEmitter {
    constructor(params) {
        super();
        const { apiKey, apiSecret, appId, version = constants_1.DEFAULT_MODEL_VERSION, protocal = constants_1.DEFAULT_API_PROTOCOL, host = constants_1.DEFAULT_API_HOST } = params;
        this.appId = appId;
